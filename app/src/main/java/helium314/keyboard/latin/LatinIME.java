...
public class LatinIME extends InputMethodService implements
    ...
    public void onUpdateSelection(final int oldSelStart, final int oldSelEnd,
        ...
        try {
            if (mVoiceComposingActive
                    && (oldSelStart != newSelStart || oldSelEnd != newSelEnd)
                    // Skip cleanup when cursor is at end of composing span with collapsed
                    // selection — this is our own setComposingText update, not user action.
                    && (composingSpanStart < 0
                            || newSelStart != composingSpanEnd
     ...
     * Discards any queued transcription work so late callbacks cannot overwrite newer edits.
     */
    ...
    private void stopVoiceRecordingGracefully() {
        ...
        Log.i(TAG, "Gracefully stopping voice input — pending transcription will complete");
    ...
    private void discardPendingVoiceWork(@NonNull final String reason) {
        ...
        final boolean hasPendingWork = mVoiceInputManager != null && mVoiceInputManager.hasPendingProcessing();
            ...
            public void onStateChanged(@NonNull VoiceInputManager.State state) {
                ...
                switch (state) {
                    ...
                    case IDLE:
                        ...
                        // there may still be pending transcription from a graceful stop.
                        // State is reset explicitly by cancelVoiceRecordingAbruptly()
                        // or cleaned up naturally as pending work completes.
                        break;
                }
            }
