...
object Defaults {
  ...
  val PREF_CLIPBOARD_TOOLBAR_KEYS = defaultClipboardToolbarPref
    ...
    const val PREF_SPEECHMATICS_MAX_DELAY_MILLIS = 1250
    const val PREF_SPEECHMATICS_END_OF_UTTERANCE_MILLIS = 750
    const val PREF_SPEECHMATICS_REMOVE_DISFLUENCIES = true
    const val PREF_SPEECHMATICS_PUNCTUATION_SENSITIVITY_PERCENT = 50
